...
class VariationalDynamicalEncoder(object):
    ...
    def train(self, x, x_con, x_valid, x_con_valid,
              epochs, num_batches,
              print_every=1,
              learning_rate=3e-4,
              beta1=0.9,
        ...
        with self.session as sess:
            ...
            for epoch in range(epochs):
                ...
                for x_batch, x_con_batch, y_one_hot_batch in utils.feed_numpy(self.batch_size, x, x_con, y=y_one_hot):
                    training_result = sess.run([self.train_op, self.cost, self.accuracy],
