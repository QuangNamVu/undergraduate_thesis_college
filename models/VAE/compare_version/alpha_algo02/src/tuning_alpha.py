...
lst_T = list(range(10, 100, 10)) + list(range(1, 10, 1)) + list(range(100, 200, 50))
lst_D = list(range(1, 10, 1)) + list(range(10, 100, 5)) + list(range(100, 200, 50))

lst_kernel0 = list(range(1, 15, 4)) + list(range(15, 33, 8))
lst_kernel1 = list(range(1, 15, 4)) + list(range(15, 33, 8))

lst_alpha = list(range(1, 20, 3))
lst_beta = list(range(1, 20, 3))
lst_gamma = list(range(1, 20, 3))
# lst_D = [1]
...
for alpha in tqdm(lst_alpha):
    for beta in tqdm(lst_beta):
        for gamma in tqdm(lst_gamma):
            ckpt_dir = os.path.expanduser("~") + '/alpha_algo02/%dA_%dB_%dY' % (alpha, beta, gamma)
