...
# attributes_normalize_mean = [
    ...
    # 'sell_amount_std', 'price_avg', 'price_std', 'cost_avg', 'cost_std',
# ]
attributes_normalize_mean = cols = [
       'Open', 'High', 'Low',
